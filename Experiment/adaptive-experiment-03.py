...
# Experiment 01 - Processes = [P0, P1, P2, P3], Sender = P0, Byzantine P0
# Processes P0, P1, P2 echo m but P3 echo m' because was misled in the send phase by P0
...
if __name__ == "__main__":
    ...
    for q in Processes:
        if q.getPhase1() == True:
            phase1Set.append(q)
            if q.getId() == "P3":
                q.alDeliverSend(q.getId(), P0, "Hello Byzantine!")
            else:
